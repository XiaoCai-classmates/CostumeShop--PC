<template>
  <div id="return-delivery">
    ...
    <div class="countents">
     <ul>
        <li>
          <div class=" countents-left"><span>配送信息</span></div>
          <div class="countents-right">
            <ul>
        ...
        <li>
          <div class="countents-left"><span>取消/退货/换货指南</span></div>
          <div class="countents-right">
            <ul>
        ...
        <li>
          <div class="countents-left"><span>无法退货/换货时</span></div>
          <div class="countents-right">
            <ul>
        ...
        <li>
          <div class="countents-left"><span>A/S指南</span></div>
          <div class="countents-right">
            <ul>
